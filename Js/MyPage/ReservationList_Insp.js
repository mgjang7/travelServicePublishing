...
$(document).on("click", ".clsReservationDetail", function () {
    ...
    if (business == "domestic") {
        location.href = PATH_MYPAGE + "ReservationDetail_Insp.aspx?reservationId=" + reservationId;
    } else {
        location.href = PATH_MYPAGE + "ReservationDetailOversea_Insp.aspx?reservationId=" + reservationId;
    }
});
