$(document).ready(function () {
    ...
    $("#btnRegister").on("click", function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.Result == 10000) {
                    funcGenerateCommonPopup("1:1문의", "문의하신 내용을 등록하였습니다", "MyPageResQna");
                } else if (res.Result == -10) {
                    funcGenerateCommonPopup("1:1문의", "예약번호가 다릅니다. <br />올바른 예약번호를 선택해주십시오.", "MyPageResQna");
                } else {
                    funcGenerateCommonPopup("1:1문의", "등록하는 중 오류가 발생 하였습니다 <br />다시 시도해주십시오.", "MyPageResQna");
                }
            },
            error: function () {
                console.log("error");
    ...
    $("#btnMod").on("click", function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.Result == 10000) {
                    funcGenerateCommonPopup("1:1문의", "문의 내용이 수정되었습니다.", "MyPageResQnaMod");
                } else if (res.Result == -10) {
                    funcGenerateCommonPopup("1:1문의", "올바른 예약번호가 아닙니다.다시 확인해주십시오.", "MypageResQna");
                } else {
                    funcGenerateCommonPopup("1:1문의", "등록하는 중 오류가 발생 하였습니다 <br />다시 시도해주십시오.", "MyPageResQna");
                }
...
function funcException(errData) {
    if (errData == 40) {
        funcGenerateCommonPopup("마이페이지", "잘못된 요청입니다.", "MyPageResQna");
    }
}
